...
import 'package:elearning/app/core/utils/configs/interceptors.dart';
...
abstract class DioClient {
  ...
  Future<Response> download(String path, String savePath, void Function(int, int)? onReceiveProgress) async {
    try {
