...
class _MeetingPageState extends State<MeetingPage> {
  ...
  final roomText = TextEditingController(text: "tes");
  final subjectText = TextEditingController(text: "My Plugin Test Meeting");
  final tokenText = TextEditingController(text: '');
  final userDisplayNameText = TextEditingController(text: "User");
  final userEmailText = TextEditingController(text: "user@email.com");
  ...
  _joinMeeting() async {
    ...
    await JitsiMeetWrapper.joinMeeting(
      ...
      listener: JitsiMeetingListener(
        ...
        onClosed: () => Get.offAllNamed('/dashboard'),
      ),
    );
  }
